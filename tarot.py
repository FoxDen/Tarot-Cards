...
class deck:
    ...
    def printCards(self, type):
        if type == "threeDeck":
            ...
            print("The Below card is below these cards, and reflects what is written within the querent's subconscious, delving deeper into the core foundation. It is represented by the "+self.usedCards[5]+". Its meaning is \n"+self.interpretation.card(self.usedCards[5])+".")
            print("These other cards are laid out to the right of the cross.")
